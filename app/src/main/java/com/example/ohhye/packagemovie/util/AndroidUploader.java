...
public class AndroidUploader	{
    ...
    static String serviceDomain = "http://210.118.74.131:8080/PackageMovie/";
    static String postUrl = serviceDomain + "uploadImage";
    static String CRLF = "\r\n";
    ...
    public ReturnCode uploadPicture(String pictureFileName)	    {
        ...
        if (uploadFile.exists())
           try 	{
                ...
                writeFormField("group_id", id);
                writeFileField("multipartFile", pictureFileName, "image/jpg", fileInputStream);
